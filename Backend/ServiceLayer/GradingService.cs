...
namespace IntroSE.Kanban.Backend.ServiceLayer
{
    ...
    public class GradingService
    {
        ...
        public GradingService()
        {
            ...
            boardS = serviceFactory.GetBoardService();
            columnS = serviceFactory.GetColumnService();
            taskS = serviceFactory.GetTaskService();
        }
        ...
        public string LimitColumn(string email, string boardName, int columnOrdinal, int limit)
        {
            try
            {
                int boardID = boardS.bc.GetBoard(email, boardName).boardID;
                return columnS.LimitColumn(email, boardID, columnOrdinal, limit);
            }
            catch (Exception ex)
            {
                Response res = new Response();
                res.ErrorMessage = ex.Message;
                return columnS.ReturnJson(res);
            }
        }
        ...
        public string GetColumnLimit(string email, string boardName, int columnOrdinal)
        {
            ...
            {
                int boardID = boardS.bc.GetBoard(email, boardName).boardID;
                return columnS.GetColumnLimit(email, boardID, columnOrdinal);
            }
            catch (Exception ex)
            {
                Response res = new Response();
        ...
        public string GetColumnName(string email, string boardName, int columnOrdinal)
        {
            ...
            {
                int boardID = boardS.bc.GetBoard(email, boardName).boardID;
                return columnS.GetColumnName(email, boardID, columnOrdinal);
            }
            catch (Exception ex)
            {
                Response res = new Response();
        ...
        public string AddTask(string email, string boardName, string title, string description, DateTime dueDate)
        {
            ...
            {
                int boardID = boardS.bc.GetBoard(email, boardName).boardID;
                return taskS.AddTask(email, boardID, title, description, dueDate);
            }
            catch (Exception ex)
            {
                Response res = new Response();
                res.ErrorMessage = ex.Message;
                return taskS.ReturnJson(res);
            }
        }
        ...
        public string UpdateTaskDueDate(string email, string boardName, int columnOrdinal, int taskId, DateTime dueDate)
        {
            ...
            {
                int boardID = boardS.bc.GetBoard(email, boardName).boardID;
                string columnName = columnS.GetColumnNameStr(email, boardID, columnOrdinal);
                return taskS.UpdateTaskDueDate(email, boardID, dueDate, columnName, taskId);
        ...
        public string UpdateTaskTitle(string email, string boardName, int columnOrdinal, int taskId, string title)
        {
            try
            {
                int boardID = boardS.bc.GetBoard(email, boardName).boardID;
                string columnName = columnS.GetColumnNameStr(email, boardID, columnOrdinal);
                return taskS.UpdateTaskTitle(email, boardID, columnName, taskId, title);
            }
            catch (Exception ex)
            {
                Response res = new Response();
        ...
        public string UpdateTaskDescription(string email, string boardName, int columnOrdinal, int taskId, string description)
        {
            try
            {
                int boardID = boardS.bc.GetBoard(email, boardName).boardID;
                string columnName = columnS.GetColumnNameStr(email, boardID, columnOrdinal);
                return taskS.UpdateTaskDescription(email, boardID, columnName, taskId, description);
            }
            catch (Exception ex)
            {
                Response res = new Response();
        ...
        public string AdvanceTask(string email, string boardName, int columnOrdinal, int taskId)
        {
            ...
            {
                int boardID = boardS.bc.GetBoard(email, boardName).boardID;
                return taskS.AdvanceTask(email, boardID, columnOrdinal, taskId);
            }
            catch (Exception ex)
            {
                Response res = new Response();
        ...
        public string GetColumn(string email, string boardName, int columnOrdinal)
        {
            try
            {
                int boardID = boardS.bc.GetBoard(email, boardName).boardID;
                string columnName = columnS.GetColumnNameStr(email, boardID, columnOrdinal);
                return columnS.GetColumn(email, boardID, columnName);
            }
            catch (Exception ex)
            {
                Response res = new Response();
        ...
        public string InProgressTasks(string email)
        {
            try
            {
                return taskS.InProgressTasks(email);
            }
            catch (Exception ex)
            {
                Response res = new Response();
        ...
        public string GetUserBoards(string email)
        {
            try
            {
                return userS.GetUserBoards(email);
            }
            catch (Exception ex)
            {
                Response res = new Response();
        ...
        public string GetBoardName(int boardId)
        {
            try
            {
                return boardS.GetBoardName(boardId);
            }
            catch (Exception ex)
            {
                Response res = new Response();
        ...
        public string JoinBoard(string email, int boardID)
        {
            try
            {
                return boardS.JoinBoard(email, boardID);
            }
            catch (Exception ex)
            {
                Response res = new Response();
        ...
        public string LeaveBoard(string email, int boardID)
        {
            try
            {
                return boardS.LeaveBoard(email, boardID);
            }
            catch (Exception ex)
            {
                Response res = new Response();
        ...
        public string AssignTask(string email, string boardName, int columnOrdinal, int taskID, string emailAssignee)
        {
            try
            {
                int boardID = boardS.bc.GetBoard(email, boardName).boardID;
                string columnName = columnS.GetColumnNameStr(email, boardID, columnOrdinal);
                return taskS.AssignTask(email, boardID, columnName, taskID, emailAssignee);
            }
            catch (Exception ex)
            {
                Response res = new Response();
        ...
        public string LoadData()
        {
            try
            {
                string UserJSON = userS.LoadData();
                var response1 = JsonSerializer.Deserialize<Response>(UserJSON);
                if (response1.ErrorMessage == null)
                    return boardS.LoadData();
                return UserJSON;
            }
            catch (Exception ex)
            {
        ...
        public string DeleteData()
        {
            try
            {
                string BoardJSON = boardS.DeleteData();
                var response1 = JsonSerializer.Deserialize<Response>(BoardJSON);
                if (response1.ErrorMessage == null)
                    return userS.DeleteData();
                return BoardJSON;
            }
            catch (Exception ex)
            {
        ...
        public string TransferOwnership(string currentOwnerEmail, string newOwnerEmail, string boardName)
        {
            try
            {
                int boardID = boardS.bc.GetBoard(currentOwnerEmail, boardName).boardID;
                return boardS.TransferOwnership(currentOwnerEmail, newOwnerEmail, boardID);
            }
            catch (Exception ex)
            {
                Response res = new Response();
